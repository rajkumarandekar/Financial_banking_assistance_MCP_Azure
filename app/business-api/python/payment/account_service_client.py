...
customer_id for ownership checks - same pattern as transaction-service's
account_service_client.py. Services must not read each other's database
tables directly, so this is a cross-service call instead.
"""
import logging
import os
