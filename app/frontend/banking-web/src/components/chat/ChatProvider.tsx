...
export function ChatProvider({ 
  ...
  /** Uses the ChatKit protocol's own threads.delete request (server.py already
   * dispatches this to whichever store is active - SQLite/memory/CosmosDB all
   * implement delete_thread) - same non-streaming POST pattern as
   * threads.list/threads.get_by_id, no new backend code needed. */
