...
param serviceName string = 'communication'
...
@description('Postgres connection string (postgresql+asyncpg://...) - passed as a Container Apps secret, never a plain env value')
@secure()
